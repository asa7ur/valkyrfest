...
VALUES ('Gojira', '+33 1 42 67 00 00', 'contact@gojira-music.com', 'Progressive Death Metal', 'France',
       ...
       ('Jinjer', '+380 44 234 5678', 'jinjer.booking@gmail.com', 'Progressive Metal', 'Ukraine', NULL, NULL, NULL,
        NULL, NULL, NULL, NULL, NULL),
       ('Metallica', '+1 415 555 0101', 'hq@metallica.com', 'Thrash Metal', 'USA', NULL, NULL, NULL, NULL, NULL, NULL,
        NULL, NULL),
       ('Mastodon', '+1 404 555 0188', 'info@mastodonrocks.com', 'Sludge Metal', 'USA', NULL, NULL, NULL, NULL, NULL,
        NULL, NULL, NULL),
       ('Evanescence', '+1 501 555 0155', 'mgmt@evanescence.com', 'Alternative Metal', 'USA', NULL, NULL, NULL, NULL,
        NULL, NULL, NULL, NULL),
       ('Tool', '+1 310 555 0199', 'toolband@management.com', 'Progressive Metal', 'USA', NULL, NULL, NULL, NULL, NULL,
        NULL, NULL, NULL),
       ('Whitechapel', '+1 865 555 0177', 'whitechapel@metalblade.com', 'Deathcore', 'USA', NULL, NULL, NULL, NULL,
        NULL, NULL, NULL, NULL),
       ('VOLA', '+45 31 12 34 56', 'contact@volaband.com', 'Progressive Metal', 'Denmark', NULL, NULL, NULL, NULL, NULL,
        NULL, NULL, NULL),
       ('Deafheaven', '+1 415 555 0122', 'info@deafheaven.com', 'Blackgaze', 'USA', NULL, NULL, NULL, NULL, NULL, NULL,
        NULL, NULL),
       ('Judas Priest', '+44 20 7946 0555', 'mgmt@judaspriest.com', 'Heavy Metal', 'UK', NULL, NULL, NULL, NULL, NULL,
        NULL, NULL, NULL),
